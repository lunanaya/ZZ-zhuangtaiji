(function () {
    ...
    const defaults = {
        ...
        worldbookCompiler: { enabled: false, selectedBookNames: [], knownBookNames: [], entryKeys: [], knownEntryKeys: [], selectionVersion:0, extraBookNames:[], excludedBookNames:[], entryOverrides:{}, budget: 500, contextMessages: 8, failClosed: true, injectionPosition: 'after_character' },
        timeoutMs: 180000,
